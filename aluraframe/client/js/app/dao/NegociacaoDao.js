                ...
                _createClass(NegociacaoDao, [{
                    ...
                    value: function adiciona(negociacao) {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            var request = _this._connection.transaction([_this._store], 'readwrite').objectStore(_this._store).add({ data: negociacao.data, quantidade: negociacao.quantidade, valor: negociacao.valor });
